...
```
docker run -d --net primenet \
	-e SPRING_DATASOURCE_URL=jdbc:oracle:thin:@oracledb:1521/ORCLCDB \
    -p 8080:8080 \
    --name crud-oracle alainpham/crud-oracle:1.0-SNAPSHOT
```
